    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-bold text-white tracking-tight flex items-center gap-2">
                Customer Portal
                <span className="text-xs px-2.5 py-0.5 rounded-full font-semibold bg-sky-500/10 border border-sky-500/20 text-sky-400">
                  CUSTOMER
                </span>
              </h1>
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-6 py-8">
        <div className="p-6 rounded-2xl bg-slate-900/60 border border-slate-800">
          <h2 className="text-xl font-bold text-white mb-2">My Customer Quotations</h2>
          <p className="text-slate-400 text-sm">View, accept, and negotiate your active sales quotations.</p>
        </div>
      </main>
    </div>
  );
